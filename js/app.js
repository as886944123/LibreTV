// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["maotai", "tyyszy","dyttzy", "bfzy", "ruyi","xiaomaomi", "ffzy","heimuer", "iqiyi", "wolong","hwba", "jisu","dbzy", "mozhua", "mdzy","zuid", "yinghua", "baidu","wujin", "wwzy","ikun", "lzi", "mdzy", "zy360"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["maotai", "tyyszy","dyttzy", "bfzy", "ruyi","xiaomaomi", "ffzy","heimuer", "iqiyi", "wolong","hwba", "jisu","dbzy", "mozhua", "mdzy","zuid", "yinghua", "baidu","wujin", "wwzy","ikun", "lzi", "mdzy", "zy360"];
